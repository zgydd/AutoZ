...
;~    $AddPrinterLocalPrinterNextTxt = "&Next >"
   ...
   $AddPrinterNewPortCls = "[CLASS:Button; INSTANCE:8]"
   ...
   $AddPrinterHaveDiskCls = "[CLASS:Button; INSTANCE:11]"
   ...
   ;$InstallFromDiskDrivePath = "C:\test\ApollonC3_DOM_RPCS_W64_V11100_20140319\oemrelease\RICOH\Drivers\RPCS\x64\disk1" ;*****
   ...
   $AddPrinterPrintTestPageCls = "[CLASS:Button; INSTANCE:16]"
